...
var G__24347 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__24347;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__24348 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24348,ch);
...
if(("\\" === ch__$1)){
var ch_24349__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_24349__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_24349__$2);
} else {
}

var G__24350 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__24350;
continue;
}
}
...
var vec__24358 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24358,(0),null);
var start_column = cljs.core.nth.call(null,vec__24358,(1),null);
...
var G__24361 = cljs.core.conj_BANG_.call(null,a,form);
a = G__24361;
continue;
}
}
...
var _STAR_read_delim_STAR_24362 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_24362;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__24363 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24363,(0),null);
var start_column = cljs.core.nth.call(null,vec__24363,(1),null);
...
var vec__24366 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24366,(0),null);
var end_column = cljs.core.nth.call(null,vec__24366,(1),null);
...
var vec__24369 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24369,(0),null);
var start_column = cljs.core.nth.call(null,vec__24369,(1),null);
...
var vec__24372 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24372,(0),null);
var end_column = cljs.core.nth.call(null,vec__24372,(1),null);
...
var vec__24375 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24375,(0),null);
var start_column = cljs.core.nth.call(null,vec__24375,(1),null);
...
var vec__24378 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24378,(0),null);
var end_column = cljs.core.nth.call(null,vec__24378,(1),null);
...
var sb = (function (){var G__24381 = (new goog.string.StringBuffer());
G__24381.append(initch);
...
var G__24383 = (function (){var G__24382 = sb;
G__24382.append(ch);

return G__24382;
})();
var G__24384 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__24383;
ch = G__24384;
continue;
}
...
switch (G__24387) {
case "\\":
var G__24391 = (function (){var G__24388 = sb;
G__24388.append(cljs.tools.reader.escape_char.call(null,sb,reader));
...
break;
default:
var G__24393 = (function (){var G__24389 = sb;
G__24389.append(ch);

return G__24389;
})();
var G__24394 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24393;
ch = G__24394;
continue;
...
var vec__24395 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24395,(0),null);
var end_column = cljs.core.nth.call(null,vec__24395,(1),null);
...
var vec__24398 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24398,(0),null);
var column = cljs.core.nth.call(null,vec__24398,(1),null);
...
var vec__24403 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24403,(0),null);
var column = cljs.core.nth.call(null,vec__24403,(1),null);
...
var vec__24408 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24408,(0),null);
var column = cljs.core.nth.call(null,vec__24408,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__24413 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24413,(0),null);
var start_column = cljs.core.nth.call(null,vec__24413,(1),null);
...
var vec__24416 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24416,(0),null);
var end_column = cljs.core.nth.call(null,vec__24416,(1),null);
...
var G__24419 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__24419,true,null,opts,pending_forms);
...
var G__24420 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__24420)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__24420)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__24420)){
...
if((form === cljs.tools.reader.READ_EOF)){
return cljs.tools.reader.impl.errors.throw_eof_error.call(null,rdr,(function (){var and__3911__auto__ = (first_line < (0));
...
var _STAR_suppress_read_STAR_24421 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_24421;
}});
...
var G__24422 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__24422,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__24422,rdr,first_line);
...
var G__24426 = matched;
var G__24427 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__24426;
finished = G__24427;
continue;
} else {
...
if(cljs.core.not.call(null,(function (){var and__3911__auto__ = opts;
if(cljs.core.truth_(and__3911__auto__)){
...
var _STAR_suppress_read_STAR_24428 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_24428;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env24429 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__24430 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24430,"(");
...
var G__24431 = (i + (1));
var G__24432 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env24429;
}});
/**
...
var ch = temp__4655__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__24433 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__24433);
...
var G__24436 = cljs.core.next.call(null,s);
var G__24437 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__24436;
key_vals = G__24437;
continue;
} else {
...
return cljs.tools.reader.add_meta.call(null,form,((cljs.core.special_symbol_QMARK_.call(null,form))?(new cljs.core.List(null,new cljs.core.Symbol(null,"quote","quote",1377916282,null),(new cljs.core.List(null,form,null,(1),null)),(2),null)):(((form instanceof cljs.core.Symbol))?(new cljs.core.List(null,new cljs.core.Symbol(null,"quote","quote",1377916282,null),(new cljs.core.List(null,(cljs.core.truth_((function (){var and__3911__auto__ = cljs.core.not.call(null,cljs.core.namespace.call(null,form));
if(and__3911__auto__){
...
var gensym_env24441 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env24441;
}});
...
var temp__4655__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__24442 = token;
var G__24442__$1 = (((G__24442 == null))?null:cljs.core.subs.call(null,G__24442,(1)));
var G__24442__$2 = (((G__24442__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24442__$1));
var G__24442__$3 = (((G__24442__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24442__$2));
var G__24442__$4 = (((G__24442__$3 == null))?null:cljs.core.symbol.call(null,G__24442__$3));
if((G__24442__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__24442__$4);
}
})():(function (){var G__24443 = token;
var G__24443__$1 = (((G__24443 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24443));
if((G__24443__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24443__$1);
}
})()
));
if(cljs.core.truth_(temp__4655__auto__)){
...
var temp__4655__auto__ = (function (){var or__3922__auto__ = cljs.tools.reader._STAR_data_readers_STAR_.call(null,tag);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}catch (e24450){if((e24450 instanceof Error)){
var e = e24450;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__24454,reader){
...
var opts = map__24455__$1;
var eof = cljs.core.get.call(null,map__24455__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4499__auto___24463 = arguments.length;
var i__4500__auto___24464 = (0);
while(true){
if((i__4500__auto___24464 < len__4499__auto___24463)){
args__4502__auto__.push((arguments[i__4500__auto___24464]));

var G__24465 = (i__4500__auto___24464 + (1));
i__4500__auto___24464 = G__24465;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq24461){
var G__24462 = cljs.core.first.call(null,seq24461);
var seq24461__$1 = cljs.core.next.call(null,seq24461);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24462,seq24461__$1);
});


//# sourceMappingURL=reader.js.map?rel=1628501143418
