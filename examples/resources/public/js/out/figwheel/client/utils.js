...
return (new CustomEvent(event_name,(function (){var obj24664 = {"detail":data};
return obj24664;
})()));
} else {
...
var f = (function (){var pred__24671 = cljs.core._EQ_;
var expr__24672 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__24671.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__24672))){
return ((function (pred__24671,expr__24672){
return (function (p1__24665_SHARP_){
return console.warn(p1__24665_SHARP_);
});
;})(pred__24671,expr__24672))
} else {
if(cljs.core.truth_(pred__24671.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__24672))){
return ((function (pred__24671,expr__24672){
return (function (p1__24666_SHARP_){
return console.debug(p1__24666_SHARP_);
});
;})(pred__24671,expr__24672))
} else {
if(cljs.core.truth_(pred__24671.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__24672))){
return ((function (pred__24671,expr__24672){
return (function (p1__24667_SHARP_){
return console.error(p1__24667_SHARP_);
});
;})(pred__24671,expr__24672))
} else {
return ((function (pred__24671,expr__24672){
return (function (p1__24668_SHARP_){
return console.log(p1__24668_SHARP_);
});
;})(pred__24671,expr__24672))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__24675){
...
var eval_fn = cljs.core.get.call(null,map__24676__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__24678_SHARP_);
});})(new_def))
);
...
if(((typeof localStorage !== 'undefined') && (typeof goog.object.get(localStorage,"setItem") !== 'undefined'))){
...
var ky = cljs.core.nth.call(null,vec__24680,(0),null);
...
if(cljs.core.truth_((function (){var and__3911__auto__ = ((typeof localStorage !== 'undefined') && (typeof goog.object.get(localStorage,"getItem") !== 'undefined'));
...
}catch (e24685){if((e24685 instanceof Error)){
var e = e24685;
return not_found;
} else {
throw e24685;
...
//# sourceMappingURL=utils.js.map?rel=1628501143824
